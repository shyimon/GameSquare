		...
		<%
				...
				{										
					...
					ElementoLista bean = (ElementoLista) it2.next();%>
						<b> - </b><a href="Game?action=gioco&id=<%=bean.getIdGioco()%>"><%=model.getGameName(bean.getIdGioco())%></a><b> - <%=bean.getCategoria()%> <input type="button" id="deleteFromList" class="setButton" value="Rimuovi"></b>
						<br>
						<br>
					<% }
				}
